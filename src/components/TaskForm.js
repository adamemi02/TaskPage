         ...
         <div className={classes.taskform}>
          ...
          <form>
            ...
            <div>
              ...
              <input type="text"  id="data1" value={props.task.data} onChange={(e)=>props.modifyInput(e,'date')}/>
            </div>
            <div>
            ...
            <div>
            <button className={classes.task_form__add_task_btn} onClick={(e)=>props.addTask(e)} disabled={props.buttonDisabled} >Add task</button>
            </div>
          </form>
